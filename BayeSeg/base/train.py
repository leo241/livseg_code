...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load('final.pth')) # 预训练载入
    # trains, vals, tests = single_domain_dataset('feilipu') # 选择单域或者域泛化做数据集划分
    # trains, vals, tests = cross_modality_dataset()
    trains, vals, tests = domain_generalization_dataset(domain1='feilipu',domain2 = 'ximenzi', ratio=[1, 1])  # 选择单域或者域泛化做数据集划分
